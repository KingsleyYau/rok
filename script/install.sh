...
sdkmanager "system-images;android-30;google_apis;x86_64" --no_https --proxy=http --proxy_host=192.168.88.133 --proxy_port=7778
sdkmanager "emulator" --no_https --proxy=http --proxy_host=192.168.88.133 --proxy_port=7778
